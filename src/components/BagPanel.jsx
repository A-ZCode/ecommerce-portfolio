...
export default function BagPanel() {
  ...
  return (
    <div className="h-full w-80 bg-gray-200 z-30 flex flex-col border-0">
      {/* Bag Header */}
      ...
      {/* View Bag Button */}
      <div className="p-4 bg-gray-200 border-0">
        <button 
          ...
          disabled={items.length === 0} onClick={() => navigate('/checkout')}
        >
          <FiShoppingBag />
          View Bag
        </button>
